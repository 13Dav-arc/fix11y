...
import { GitHubAppService, resolveRunnerToken } from '../../lib/github-app.js';
...
export async function POST(req) {
  try {
    ...
    // 9. Resolve runner repo token enforcing strict precedence (App token > static PAT > targetToken)
